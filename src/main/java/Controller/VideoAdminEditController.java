...
@WebServlet(urlPatterns = { "/admin/home/videos/add", "/admin/home/videos/update", "/admin/home/videos/delete" })
@MultipartConfig(maxFileSize = 1024 * 1024 * 50, 
		maxRequestSize = 1024 * 1024 * 100) 
public class VideoAdminEditController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		switch (path) {
		case "/admin/home/videos/add":
			doGetAdd(req, resp);
			break;
		case "/admin/home/videos/update":
			doGetUpdate(req, resp);
			break;
		case "/admin/home/videos/delete":
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "/admin/home/videos/update":
			...
			break;
		default:
			resp.sendRedirect(req.getContextPath() + "/admin/home/videos");
			break;
		}
	}
	...
	private void doGetAdd(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/views/admin/video-add.jsp");
	...
	private void doGetUpdate(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			RequestDispatcher dispatcher = req.getRequestDispatcher("/views/admin/video-update.jsp");
			dispatcher.forward(req, resp);
		} catch (Exception e) {
